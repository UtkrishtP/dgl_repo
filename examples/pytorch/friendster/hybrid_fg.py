...
def process_func(g, model, train_idx, sampler_, batch, workers, cache_size, epoch_, dataset):
    ...
    transfer_queue = Queue(mini_batch * 2) # Queue size has been kept 4 times the mini_batch size. TODO: Make it dynamic
...
if __name__ == "__main__":
    ...
    process_func(g, model, train_idx, args.sampler, 
                 args.batch_size, args.workers, args.cache_size, args.epoch, "friendster")
