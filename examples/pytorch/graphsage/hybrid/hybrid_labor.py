...
def train(args, device, g, dataset, model, num_classes, f, batch_size, workers, use_uva, _pin, _alternate, _prefetch_th, epoch_):
    ...
    gpu_labor_sampler = LaborSampler(
        [10, 10, 10],
        prefetch_node_feats=["feat"],
        prefetch_labels=["label"],
    )
...
if __name__ == "__main__":
    ...
    for epoch in epoch_:
        ...
        train(args, device, g, dataset, model, num_classes, f, 512, 32, args.uva, args.pin_prefetcher, args.alternate_streams, args.prefetch_thread, epoch)
        ...
        train(args, device, g, dataset, model, num_classes, f, 2048, 32, args.uva, args.pin_prefetcher, args.alternate_streams, args.prefetch_thread, epoch)
        ...
        train(args, device, g, dataset, model, num_classes, f, 8192, 64, args.uva, args.pin_prefetcher, args.alternate_streams, args.prefetch_thread, epoch)
