...
def main():
    ...
    datasets = ["ogbn-papers100M", "friendster" ,"twitter"]
    # datasets = ["friendster" ,"twitter"]
    # datasets = ["igb-medium"] #, "igb-large", "igb-hom"]
    batch_sizes = [8192, 1024]
    # file_name_ = ["ggg.py"  ,"hybrid_102.py"]
    file_name_ = ["hybrid_103.py"]
    epoch = 10
    ...
    for _dataset in datasets:
        ...
        for file_name in file_name_:
            for batch_size in batch_sizes:
                run_node_classification(batch_size, file_name, epoch, args.mfg_size, _dataset)
